...
const EXPLICIT = {
  ...
  expertise_teras_kasi_dam:                'Teras Kasi Damage',
  expertise_teras_kasi_acr:                'Teras Kasi Efficiency',
  expertise_teras_kasi_adv_armor_all:      'Advanced All-Armor',
  expertise_teras_kasi_cc:                 'Teras Kasi Critical Chance',
  expertise_teras_kasi_dr:                 'Damage Reduction',
  expertise_teras_kasi_armor_mgb:          'Melee/Grenade/Blast Armor',
  expertise_tk_unhealthy_fixation:         'Unhealthy Fixation',
  expertise_tk_thrill:                     'Thrill',
  expertise_tk_project_will:               'Project Will',
  expertise_tk_allure:                     'Allure',
  expertise_tk_thrill_dur:                 'Thrill Duration',
  expertise_tk_void_dance:                 'Void Dance',
  expertise_tk_sweeping_pirouette:         'Sweeping Pirouette',
  ...
  expertise_tkm_taunt:                     'Taunt',
  expertise_tkm_ae_taunt:                  'Area Taunt',
  ...
  expertise_bh_cover:                      'Cover',
  expertise_rifleman_rifle_dam:            'Rifle Damage',
  expertise_co_ae_dm:                      'Area Damage',
  ...
  expertise_sp_fld_debuff_ca:              'Field Debuff Chance',
  ...
  expertise_bh_tangle:                     'Tangle',
  expertise_bh_trap_dam:                   'Trap Damage',
  expertise_bh_armor_duelist:              'Armor Duelist',
  expertise_bh_crit:                       'Critical Chance',
  expertise_bh_eye_shot:                   'Eye Shot',
  expertise_sp_noxious_traps:              'Noxious Traps',
  expertise_bh_intimidate:                 'Intimidate',
  expertise_bh_fumble:                     'Fumble',
  expertise_bh_man_crit:                   'Manipulation Critical',
  expertise_bh_confusion_shot:             'Confusion Shot',
  expertise_bh_taunt:                      'Taunt',
  ...
  expertise_bh_stun:                       'Stun',
  expertise_bh_reveal:                     'Reveal',
  expertise_bh_shields:                    'Shields',
  combat_bountyhunter_master:              'Bounty Hunter Master',
  ...
  expertise_co_double_time:                'Double Time',
  ...
  expertise_co_armor_cracker:              'Armor Cracker',
  expertise_co_ae_taunt:                   'Area Taunt',
  expertise_co_taunt:                      'Taunt',
  combat_commando_master:                  'Commando Master',
  ...
  expertise_sm_buff_invis_ally:            'Invisibility Ally Buff',
  ...
  expertise_sm_path_loaded_chance_dice:    'Loaded Chance Dice',
  ...
  expertise_of_aoe_act:                    'Area Action Cost',
  expertise_co_shock_grenade:              'Shock Grenade',
  expertise_co_blast_radius:               'Blast Radius',
  expertise_co_flashbang:                  'Flashbang',
  expertise_co_del_ae_cc_1:                'Delayed Grenade I',
  expertise_of_aoe_dam:                    'Area Damage',
  expertise_of_dioxis:                     'Dioxis Cloud',
  expertise_gr_adv_acr:                    'Advanced Efficiency',
  expertise_co_timer_reset:                'Timer Reset',
  expertise_co_del_ae_cc_2:                'Delayed Grenade II',
  expertise_of_aoe_crit:                   'Area Critical Chance',
  expertise_co_del_ae_dm:                  'Delayed Damage',
  expertise_co_angled_shrapnel:            'Angled Shrapnel',
  expertise_co_fld_dm:                     'Field Damage',
  expertise_gr_anti_evade:                 'Anti-Evade',
  expertise_of_shock:                      'Shock',
  expertise_of_del_ae_dm_dot:              'Delayed Area DoT',
  expertise_gr_blast_resistance:           'Blast Resistance',
  expertise_of_artillery:                  'Artillery',
  expertise_of_firepower:                  'Firepower',
  expertise_of_firepower_cool:             'Firepower Cooldown',

  // ── COMBAT MEDIC (science_combatmedic) ───────────────────────────────────
  science_combatmedic_novice:              'Combat Medic Novice',
  expertise_me_me_dm_dot:                  'DoT Damage',
  expertise_sp_cc_dot:                     'Crowd Control DoT',
  expertise_cm_damage:                     'Medic Damage',
  expertise_me_electrolyte_drain:          'Electrolyte Drain',
  expertise_me_me_fld_dm_dot:              'Field DoT Damage',
  expertise_me_serotonin_purge:            'Serotonin Purge',
  expertise_cm_dot_dam:                    'DoT Damage Boost',
  expertise_cm_crit:                       'Critical Chance',
  expertise_me_traumatize:                 'Traumatize',
  expertise_me_induce_insanity:            'Induce Insanity',
  expertise_me_bacta_resistance:           'Bacta Resistance',
  expertise_cm_acr:                        'Efficiency',
  expertise_sp_improved_spys_fang:         "Spy's Fang",
  expertise_me_thyroid_rupture:            'Thyroid Rupture',
  expertise_cm_dot_dur:                    'DoT Duration',
  science_combatmedic_master:              'Combat Medic Master',
  ...
  expertise_doc_acr:                       'Doctor Efficiency',
  expertise_me_me_bacta_ampule:            'Bacta Ampule',
  expertise_me_enhancement_specialist:     'Enhancement Specialist',
  expertise_me_hot_duration:               'HoT Duration',
  expertise_doc_cleanse:                   'Cleanse',
  expertise_doc_hp:                        'Healing Power',
  expertise_me_me_ae_heal:                 'Area Heal',
  expertise_me_agro_healing:               'Agro Healing',
  ...
  science_doctor_master:                   'Doctor Master',
  expertise_me_stasis:                     'Stasis',
  expertise_me_kinetic_armor:              'Kinetic Armor',

  // ── SQUAD LEADER (outdoors_squadleader) ──────────────────────────────────
  outdoors_squadleader_novice:             'Squad Leader Novice',
  expertise_sl_dta:                        'Damage to Action Cost',
  expertise_of_paint_dam:                  'Paint Damage',
  expertise_sl_acr:                        'Efficiency',
  expertise_of_paint_act:                  'Paint Action Cost',
  expertise_of_armor_kin:                  'Armor Kinetic Defense',
  ...
  expertise_sl_leadership:                 'Leadership',
...
const TREE_SPECIFIC = {
  combat_carbine:      { expertise_marksman_ability: 'Tactical Strike' },
  combat_rifleman:     { expertise_marksman_ability: 'Tactical Strike' },
  combat_bountyhunter: { expertise_marksman_ability: 'Tactical Strike' },
};
